...
export default function PracticeProblemsPage() {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `practice-problems-${new Date().toISOString().split('T')[0]}.md`;
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-base">
            Create personalized practice problems based on the questions you've asked and the areas where you needed help.
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Generate practice problems from all assignments or focus on a specific one.
              </p>
            </div>
          ...
          {generatedMaterials && (
            <div className="space-y-4 border-t pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-medium">Generated Practice Problems</h3>
